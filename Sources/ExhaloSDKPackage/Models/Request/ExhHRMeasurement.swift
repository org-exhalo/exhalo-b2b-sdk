...
public class ExhHRMeasurement: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case motionContext = "motionContext"
    }
    ...
    required public init(from decoder: Decoder) throws {
        ...
        motionContext = try values.decode(String.self, forKey: .motionContext)
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(motionContext, forKey: .motionContext)
    }
}

extension ExhHRMeasurement: Datable {
